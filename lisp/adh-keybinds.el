...
(keymap-set global-map "C-," (=> (duplicate-dwim) (next-line)))
...
(keymap-set adh-window-keymap "x" #'windower-toggle-single)
...
(with-eval-after-load 'multiple-cursors
  ...
  (keymap-set mc/keymap "<escape>" #'adh-mc-or-meow-quit))
